/*２つのファイルをコマンド引数として受け取り、それらのファイルが、①等しいか、②先頭からのn-1バイトは等しいがnバイト目が等しくないか、③はじめに受け取ったファイルの終わりまではもう一方のあとに受け取ったファイルと完全に一致しているが、あとに受け取ったファイルにはまだ続きがあるか、④その逆の４パターンで判別します。*/
